...
import {
  ApyHistorySchema, CctpMessageSchema, IApyHistoryModel, ICctpMessageModel,
  INetworkModel, IPoolModel, IRebalanceHistoryModel, ISyncModel, IVaultModel,
  NetworkSchema, PoolSchema, RebalanceHistorySchema, SyncSchema, VaultSchema
} from './models';
...
async function defineCollection(): Promise<{
  ...
  const cctpMessageModel = model<ICctpMessageModel>('CctpMessage', CctpMessageSchema, 'CctpMessage', { connection });
